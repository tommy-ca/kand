...
...
///   >>> signal = kand.cdl_gravestone_doji_inc(100.0, 102.0, 99.8, 99.9, 5.0)
///   ```
#[pyfunction]
...
pub fn cdl_gravestone_doji_inc_py(
    ...
    py.allow_threads(|| cdl_gravestone_doji::cdl_gravestone_doji_inc(open, high, low, close, body_percent))
