...
macro_rules! kand_py_arrow_wrapper_multi {
    ...
    (
        ...
        pub fn $name(
            ...
            pyo3_arrow::PyArray, pyo3_arrow::PyArray, pyo3_arrow::PyArray, pyo3_arrow::PyArray, pyo3_arrow::PyArray,
            pyo3_arrow::PyArray, pyo3_arrow::PyArray, pyo3_arrow::PyArray, pyo3_arrow::PyArray, pyo3_arrow::PyArray
        )> {
            use std::sync::Arc;
            use kand::ta::types::TAArrowArray;
            ...
            let (r1, r2, r3, r4, r5, r6, r7, r8, r9, r10) = py.allow_threads(|| $arrow_fn($($input_name,)+ $($param_name),*))
                .map_err(|e| pyo3::exceptions::PyValueError::new_err(e.to_string()))?;
            ...
            Ok((
                ...
                pyo3_arrow::PyArray::new(Arc::new(r6), first_input.field().clone()),
                pyo3_arrow::PyArray::new(Arc::new(r7), first_input.field().clone()),
                pyo3_arrow::PyArray::new(Arc::new(r8), first_input.field().clone()),
                pyo3_arrow::PyArray::new(Arc::new(r9), first_input.field().clone()),
                pyo3_arrow::PyArray::new(Arc::new(r10), first_input.field().clone())
            ))
        }
    };
}
